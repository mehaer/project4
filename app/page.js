      ...
      <Box sx = {{my:6}}>
        ...
        <Grid container spacing={4}>
          ...
          <Grid item xs={12} md={4}>
            ...
            <Typography>Our AI breaks down your text into concise flashcards perfect for studying</Typography>
          </Grid>
          <Grid item xs={12} md={4}>
        ...
        <Grid container spacing={4}>
          ...
          <Grid item xs={12} md={6}>
            <Box sx={{
              ...
              <Typography>Limited flashcards and storage with priority support</Typography>
